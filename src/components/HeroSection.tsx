...
const HeroSection: React.FC = () => {
  ...
  return (
    <section id="hero" className="relative overflow-hidden border-b border-slate-800/60 bg-slate-950">
      ...
      <div className="relative mx-auto flex min-h-[70vh] max-w-6xl flex-col gap-12 px-6 pb-20 pt-28 lg:flex-row lg:items-center">
        {/* LEFT */}
        ...
        <div className="flex w-full justify-center lg:w-[360px]">
          <div className="w-full max-w-sm rounded-[32px] border border-slate-800/80 bg-slate-950/90 p-6 shadow-[0_24px_80px_rgba(15,23,42,0.95)] backdrop-blur">

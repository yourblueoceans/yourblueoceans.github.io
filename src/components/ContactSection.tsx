    ...
    <motion.section id="contact" className={sectionClass} {...sectionMotion}>
      <div className={`${innerClass} max-w-4xl`}>
        <div className={`${cardClass} text-center`}>
          ...
          <h2 className={heading2}>웹 취약점 진단·클라우드 보안 PoC에 대해 이야기 나누고 싶으시다면</h2>
          <p className="section-lead mt-3">인턴·주니어 포지션, 프로젝트 협업, 보안 컨설팅/영업 관련 논의 등 언제든지 편하게 연락 주세요.</p>
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <button type="button" onClick={handleEmail} className="btn-primary text-sm">
              이메일 보내기
            </button>
            <a href="https://github.com/yourblueoceans" target="_blank" rel="noreferrer" className="btn-secondary text-sm text-slate-900">
              GitHub 보기
            </a>
          </div>
